export default {
  ...
  agent: {
    ...
    orchestrator: {
      title: 'Agent编排器',
      subtitle: '按AppKey编排 OpenAI Agents SDK 配置，保存后即时更新该AppKey的Agent实例',
      save: '保存并更新实例',
      refresh: '刷新实例',
      configured: '已配置',
      notConfigured: '未配置',
      ...
      mode: '协作模式',
      modeSingle: '单Agent',
      modeTool: 'Agent作为工具(并行)',
      modeHandoff: 'Handoff交接',
      model: '模型',
      modelPh: '留空则使用 system_llm 配置模型',
      maxTurns: '最大轮数',
      enabled: '启用',
      instructions: '指令(Instructions)',
      instructionsPh: '描述该Agent的角色与行为',
      plugins: '已挂载插件',
      addBuiltin: '选择内置插件',
      add: '添加',
      noPlugins: '暂无插件',
      subAgents: '子Agent',
      addSubAgent: '新增子Agent',
      noSubAgents: '暂无子Agent，请新增',
      subName: '子Agent名称',
      toolName: '工具名称',
      toolDesc: '工具描述',
      subPlugins: '挂载插件',
    ...
    plugins: {
      title: 'Agent插件编辑器',
      subtitle: '在线编辑 MCP 插件脚本，输入参数调试后保存，保存即更新该AppKey的Agent实例',
      new: '新建插件',
      newTitle: '新建插件',
      editTitle: '编辑插件',
      empty: '暂无插件',
      ...
      sort: '排序',
      script: 'MCP脚本',
      scriptPh: '基于 FastMCP 的 MCP stdio 服务脚本',
      configJson: '配置(JSON)',
      debug: '调试',
      debugHint: '先点击“加载工具”发现脚本中的工具并自动填充参数模板，再填写参数后点击“运行调试”查看脚本返回结果。',
      toolName: '工具名',
      toolNamePh: '选择或填写要调用的工具',
      loadTools: '加载工具',
      toolArgs: '调用参数(JSON)',
      runDebug: '运行调试',
      callResult: '调用结果',
      rawResult: '原始返回(含工具列表)',
      result: '调试结果'
    }
  },
  user: {
