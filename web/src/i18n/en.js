export default {
  ...
  agent: {
    ...
    orchestrator: {
      ...
      subtitle: 'Orchestrate the OpenAI Agents SDK config per AppKey; saving rebuilds that AppKey\'s Agent instance',
      save: 'Save & Update Instance',
      ...
      mode: 'Mode',
      modeSingle: 'Single',
      modeTool: 'Agent-as-tool (parallel)',
      modeHandoff: 'Handoff',
      model: 'Model',
      modelPh: 'Leave blank to use system_llm model',
      maxTurns: 'Max Turns',
      enabled: 'Enabled',
      instructions: 'Instructions',
      instructionsPh: 'Describe the agent role and behavior',
      plugins: 'Attached Plugins',
      addBuiltin: 'Select builtin plugin',
      add: 'Add',
      noPlugins: 'No plugins',
      subAgents: 'Sub-agents',
      addSubAgent: 'Add Sub-agent',
      noSubAgents: 'No sub-agents yet',
      subName: 'Sub-agent Name',
      toolName: 'Tool Name',
    ...
    plugins: {
      title: 'Agent Plugin Editor',
      subtitle: 'Edit MCP plugin scripts online, debug with params, then save to rebuild the instance',
      new: 'New Plugin',
      newTitle: 'New Plugin',
      ...
      sort: 'Order',
      script: 'MCP Script',
      scriptPh: 'A FastMCP-based MCP stdio server script',
      configJson: 'Config (JSON)',
      debug: 'Debug',
      debugHint: 'Click "Load Tools" to discover the script\'s tools and auto-fill an argument template, then fill in the args and click "Run Debug" to see the script result.',
      toolName: 'Tool Name',
      toolNamePh: 'Select or type the tool to call',
      loadTools: 'Load Tools',
      toolArgs: 'Tool Args (JSON)',
      runDebug: 'Run Debug',
      callResult: 'Call Result',
      rawResult: 'Raw response (incl. tool list)',
      result: 'Result'
    }
  },
  user: {
