export default {
  ...
  admin: {
    ...
    menu: {
      ...
      agentOrchestrator: 'Agentオーケストレーター',
      agentPlugins: 'Agentプラグイン',
      chatDebug: 'チャットデバッグ'
    }
  },
  agent: {
    ...
    orchestrator: {
      title: 'Agentオーケストレーター',
      subtitle: 'AppKeyごとに OpenAI Agents SDK の設定を編成し、保存すると該当AppKeyのAgentインスタンスを更新します',
      save: '保存してインスタンス更新',
      refresh: 'インスタンス更新',
      configured: '設定済み',
      notConfigured: '未設定',
      ...
      mode: 'モード',
      modeSingle: '単一Agent',
      modeTool: 'Agentをツール化(並列)',
      modeHandoff: 'Handoff',
      model: 'モデル',
      modelPh: '空欄の場合は system_llm のモデルを使用',
      maxTurns: '最大ターン数',
      enabled: '有効',
      instructions: '指示(Instructions)',
      instructionsPh: 'Agentの役割と動作を記述',
      plugins: '接続中プラグイン',
      addBuiltin: '組込プラグインを選択',
      add: '追加',
      noPlugins: 'プラグインなし',
      subAgents: 'サブAgent',
      addSubAgent: 'サブAgent追加',
      noSubAgents: 'サブAgentがありません',
      subName: 'サブAgent名',
      toolName: 'ツール名',
      toolDesc: 'ツール説明',
      subPlugins: 'プラグイン',
    ...
    plugins: {
      title: 'Agentプラグインエディタ',
      subtitle: 'MCPプラグインスクリプトをオンライン編集し、パラメータでデバッグして保存するとインスタンスを更新します',
      new: '新規プラグイン',
      newTitle: '新規プラグイン',
      editTitle: 'プラグイン編集',
      empty: 'プラグインなし',
      ...
      sort: '並び順',
      script: 'MCPスクリプト',
      scriptPh: 'FastMCPベースの MCP stdio サーバースクリプト',
      configJson: '設定(JSON)',
      debug: 'デバッグ',
      debugHint: 'まず「ツール読込」でスクリプトのツールを検出し引数テンプレートを自動入力、引数を入力後「デバッグ実行」で結果を確認します。',
      toolName: 'ツール名',
      toolNamePh: '呼び出すツールを選択または入力',
      loadTools: 'ツール読込',
      toolArgs: '呼び出し引数(JSON)',
      runDebug: 'デバッグ実行',
      callResult: '呼び出し結果',
      rawResult: '生レスポンス(ツール一覧含む)',
      result: '結果'
    }
  },
  user: {
